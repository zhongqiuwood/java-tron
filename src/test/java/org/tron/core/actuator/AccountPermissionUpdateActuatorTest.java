...
public class AccountPermissionUpdateActuatorTest {
  ...
  public void witnessNeedless() {
    ...
    processAndCheckInvalid(
        actuator, ret, "account isn't witness can't set witness permission",
  ...
  public void checkAvailableContractTypeCorrespondingToCode() {
    ...
    for (ContractType contractType : ContractType.values()) {
      if (contractType == org.tron.protos.Protocol.Transaction.Contract.ContractType.UNRECOGNIZED
          ...
          || contractType == ContractType.DeferredTransactionContract) {
        continue;
      }
  ...
  public void checkAvailableContractType() {
    String validContractType = "7fff1fc003fe0300000000000000000000000000000000000000000000000000";
  ...
  public void checkActiveDefaultOperations() {
    String validContractType = "7fff1fc003be0300000000000000000000000000000000000000000000000000";
