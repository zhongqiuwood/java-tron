...
@Setter
public class MultiValiSignPerformance extends AbstractTransactionCreator implements
    GoodCaseTransactonCreator {

  private String ownerAddress = triggerOwnerAddress;
  private String contractAddress = commonContractAddress11;
  private long callValue = 0L;
  private String methodSign = "validateSign(bytes32,bytes,address)";
  ...
  protected Protocol.Transaction create() {
    ...
    param = "\"0x" + Hex.toHexString(hash) + "\",\"" + Hex.toHexString(sign) + "\",\"" + Wallet
        .encode58Check(key.getAddress()) + "\"";
    try {
