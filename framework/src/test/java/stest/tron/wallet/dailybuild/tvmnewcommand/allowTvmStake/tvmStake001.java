package stest.tron.wallet.dailybuild.tvmnewcommand.allowTvmStake;
...
public class tvmStake001 {
  ...
  public void beforeClass() {
    ...
    String filePath = "src/test/resources/soliditycode/TvmStake.sol";
  ...
  public void test01StakeAddress() {
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    String txid = "";
    String num = "\"" + "TB4B1RMhoPeivkj4Hebm6tttHjRY9yQFes" + "\"" + ","+1000000L;
    txid = PublicMethed
        .triggerContract(contractAddress, "Stake(address,uint256)", num, false, 0,
